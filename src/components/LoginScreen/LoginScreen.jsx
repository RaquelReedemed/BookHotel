      ...
      <>
        ...
        <div className='login'>
         ...
         {/* <div className='bottom'>
                 <Link className='create' type="submit" onClick={loginWithGoogle}>
                 
                 
                 Login with Google<FontAwesomeIcon id='iconCarta' icon={faEnvelope}/></Link>
         </div>   
                */}

                <button className="buttonGoogle">
                <Link type="submit" onClick={loginWithGoogle}>
