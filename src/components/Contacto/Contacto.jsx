            ...
            {/* Nombre */}
                <div className="input-block">
                    <input
                      ...
                      type="text" 
                     />
                    <label className={darkMode ? 'dark-modeP': ''} for="email">Tu nombre</label>
                </div>
                {/* Email */}
                <div className="input-block">
                    <input 
                    ...
                    type="text" 
                    />
                    <label className={darkMode ? 'dark-modeP': ''} for="pass">E-mail</label>
                </div>
                ...
                <div className="input-block">
                    ...
                    type="text" 
                    />
                    <label className={darkMode ? 'dark-modeP': ''} for="pass">Mensaje</label>
                </div>


                <div className="input-block">
                <button className='btnEnvCont'>Enviar</button>
            </div>
            </form>
        </div>

         <div className="rightCont">
            <div className="img"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 731.67004 550.61784" xmlns:xlink="http://www.w3.org/1999/xlink">
